...
2. Run `npm run test:e2e` to load the unpacked extension in Chromium and verify Office theme rendering on the board directory, hot boards, category pages, board article lists, article pages, and the over-18 confirmation page.
